import HandHudSprite from "../HudSprite/HandHudSprite.js";
import socket from "../../socket.js";
import WeaponMode from "./WeaponMode.js";
import Input from "../Input.js";

export default class WeaponModeHand extends WeaponMode{

    constructor(player) {
        super()
        this.player = player
        this.hud = new HandHudSprite(this.player)
